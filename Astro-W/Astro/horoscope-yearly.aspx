<%@ Page Title="" Language="C#" MasterPageFile="~/AstroMaster.master" AutoEventWireup="true" CodeFile="horoscope-yearly.aspx.cs" Inherits="horoscope_yearly" %>
    ...
    <div class="col-12">
        <div class="as_blog_box as_blog_single1 as_padderBottom80">
                            <div class="as_tag_wrapper">
                                <ul>
                                    <li><a href="horoscope-daily.aspx" class="as_btn"><h5>Daily Horoscope</h5></a></li>
                                    <li><a href="horoscope-monthly.aspx" class="as_btn"><h5>May 2026 Horoscope</h5></a></li>
                                    <li class="active"><a href="#" class="as_btn active"><h5>Year 2026 Horoscope</h5></a></li>
                                </ul>
                            </div>
        </div>
    </div>
