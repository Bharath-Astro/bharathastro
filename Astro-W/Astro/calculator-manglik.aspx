<%@ Page Title="" Language="C#" MasterPageFile="~/AstroMaster.master" AutoEventWireup="true" CodeFile="calculator-manglik.aspx.cs" Inherits="calculator_manglik" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
        ...
        <div class="container">
            <div class="row as_verticle_center text-center">
                <div class="col-lg-12 col-md-12">
                    <h1 class="as_heading auto"> Get Your Unique Mangal or Kuja Dosha Analysis based on Your Kundli
                    </h1>
                </div>
            </div>
        ...
        <div class="container">
            ...
            <div class="row">
                ...
                <div class="col-lg-6 col-md-6">
                    <p> Mangal Dosh, also known as Manglik Dosha, Kuja Dosha, and Chevvai/Sevvai Dosham, is regarded as
                        the most powerful Dosha in one's horoscope. Mars is also known as the planet Mangal in northern
                        India, and Chevvai or Sevvai in Southern India. </p>
                    <a href="#form" class="as_btn">Get Your Free Manglik Report Now</a>
                </div>
            </div>
        ...
        <div class="container">
            ...
            <div class="row">
                <div class="col-lg-7 col-md-7 ">
                    <h1 class="heading"> What is Manglik Dosha? </h1>
                    <div class="as_padderTop30">
                        <p> In the boy or the girl's horoscope when Mars, Sun, Saturn, Rahu, or Ketu is in the
                            ascendant, fourth house, seventh house, eighth house, or twelfth house then it is called
                            Manglik or Kuja dosha. </p>
                        <p> Manglik dosh is considered stronger when Mars is placed in the ascendant than when Mars is
                            conjoined with Moon in the ascendant. If according to the Shastras the Manglik dosh of both
                            the boy and the girl's getting canceled then they are guaranteed a happily married life.
                        </p>
                        <a href="#form" class="as_btn">Get Your Free Manglik Report Now</a>
                    </div>
                </div>
                <div class="col-lg-5 col-md-5 ">
                    <img src="images/ml1.png" alt="" class="img-fluid">
                </div>
            </div>
    ...
    <section class="as_service_wrapper as_padderTop80 as_padderBottom80">
        <div class="container">
            ...
            <div class="row">
                <div class="col-md-12">
                    <h1 class="subheading"> TYPES OF MANGAL DOSHAS: </h1>
                </div>
            </div>
            <div class="row">
                <div class="col-lg-6 col-md-6">
                    <div class="as_service_box text-center">
                        <h2 class="subheading"> High Mangal Dosha </h2>
                        <p> Occurs when Mars is situated in the first, second, fourth, seventh, eighth, or twelfth houses of the Natal Chart, Moon Chart, or Venus Chart. A person's life may be filled with many difficulties. </p>
                    </div>
                </div>
                <div class="col-lg-6 col-md-6">
                    <div class="as_service_box text-center">
                        <h2 class="subheading"> Low Mangal Dosha </h2>
                        <p> If Mars is situated in the first, second, fourth, seventh, eighth, or twelfth houses of any of these three charts, such as the Natal Chart, Moon Chart, or Venus Chart, it is considered Low Manglik Dosha or "Partial Manglik Dosha". According to certain astrologers, it may be nullified beyond the age of 28. </p>
                    </div>
                </div>
                <div class="col-md-12 pt-40">
                    <p class="text-center"> You can find out about Manglik Dosha's high or low intensity using the Mangal Dosha calculator. Sometimes, it is also considered as if the planet Mars is aspected by the benefic planet like Jupiter or Venus, then this Dosha is canceled in your birth chart. </p>
                </div>
            </div>
        </div>
    </section>
    ...
    <section class="as_about_wrapper as_padderTop80 as_padderBottom80">
        <div class="container">
            ...
            <div class="row">
                <div class="col-lg-12 col-md-12">
                    <h1 class="subheading"> EFFECTS OF MANGAL DOSH </h1>
                    <div class="n_p_flex">
                        <p class="npf_n"> 1 </p>
                        <p>  If Mars is placed in the 1st house, it may induce marital problems </p>
                    </div>
                    <div class="n_p_flex">
                        <p class="npf_n"> 2 </p>
                        <p> If Mars is situated in the 2nd house, it may produce problems in the family and, eventually, in the marriage life. </p>
                    </div>
                    <div class="n_p_flex">
                        <p class="npf_n"> 3 </p>
                        <p> If Mars is placed in the 4th house, it may produce difficulties on the professional front. </p>
                    </div>
                    <div class="n_p_flex">
                        <p class="npf_n"> 4 </p>
                        <p> If Mars is placed in the 7th house, it may boost a person's power, which may lead to discord in a partnership. </p>
                    </div>
                    <div class="n_p_flex">
                        <p class="npf_n"> 5 </p>
                        <p> If Mars is in the 9th house, it may result in the loss of paternal property. </p>
                    </div>
                    <div class="n_p_flex">
                        <p class="npf_n"> 6 </p>
                        <p> If Mars is placed in the 12th house, it may bring mental stress and hence have an impact on family life. </p>
                    </div>
        ...
        <div class="container">
            ...
            <div class="row">
                <div class="col-lg-12 col-md-12">
                    ...
                    <h1 class="heading text-center"> FAQs about Manglik Dosha </h1>
