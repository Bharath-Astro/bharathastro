<%@ Page Title="" Language="C#" MasterPageFile="~/AstroMaster.master" AutoEventWireup="true" CodeFile="blog-detail.aspx.cs" Inherits="blog_detail" %>
                    ...
                    <div class="col-lg-9 col-md-8">
                        <div class="as_blog_box as_blog_single as_padderBottom80">
                            <div class="as_blog_img">
                                <img src="https://dummyimage.com/966x555" alt="" class="img-responsive">
                            ...
                            <div class="row as_padderBottom20">
                                <div class="col-xl-4 col-lg-5 col-md-12 col-sm-12">
                                    <img src="https://dummyimage.com/270x190" alt="">
                                </div>
                        ...
                        <div class="as_about_admin">
                            <div class="as_aboutImage">
                                <img src="https://dummyimage.com/111x111" alt="" class="img-responsive">
                            </div>
