<%@ Page Title="" Language="C#" MasterPageFile="~/AstroMaster.master" AutoEventWireup="true" CodeFile="horoscope.aspx.cs" Inherits="horoscope" %>
            ...
            <div class="container">
                <div class="row">
                    <div class="col-lg-10 col-md-12 col-sm-12 col-xs-12 col-lg-offset-1">
                        ...
                        <h1 class="as_heading as_heading_center">Daily Horoscope Prediction</h1>
                        </div>
                        <div class="ast_pp_section">
                            <h5 class="as_orange as_subheading as_padderTop10 as_padderBottom10">Leo</h5>
                            <p class="as_font14"><asp:Literal ID="litDailyHoroscopePrediction" runat="server"></asp:Literal></p>
