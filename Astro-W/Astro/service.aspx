<%@ Page Title="" Language="C#" MasterPageFile="~/AstroMaster.master" AutoEventWireup="true" CodeFile="service.aspx.cs" Inherits="service" %>
                ...
                <div class="row">
                    ...
                    <div class="col-lg-3 col-md-4 col-sm-6 col-xs-12">
                        <div class="as_service_box text-center">
                            ...
                            <a href="service-detail.aspx" class="as_link">read more</a>
                        </div>
                    </div>
                    <div class="col-lg-3 col-md-4 col-sm-6 col-xs-12">
                        <div class="as_service_box text-center">
