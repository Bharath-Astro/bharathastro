<%@ Page Title="" Language="C#" MasterPageFile="~/AstroMaster.master" AutoEventWireup="true" CodeFile="zodiac-single.aspx.cs" Inherits="zodiac_single" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
                        ...
                        <div class="as_zodiac_single_inner">
                            ...
                            <div class="as_tab_wrapper">
                                ...
                                <div class="tab-content" id="myTabContent">
                                       ...
                                       <div class="as_countdown_wrapper">
                                            <ul>
                                                <li class="text-center">
                                                    <!-- <span>45%</span> -->
                                                    <div class="as_progressbar p1"></div>
                                                    <h3>Love</h3>
                                                </li>
                                                <li class="text-center">
                                                    <div class="as_progressbar p2"></div>
                                                    <h3>career</h3>
                                                </li>
                                                <li class="text-center">
                                                    <div class="as_progressbar p3"></div>
                                                    <h3>money</h3>
                                                </li>
                                                <li class="text-center">
                                                    <div class="as_progressbar p4"></div>
                                                    <h3>health</h3>
                                                </li>
                                                <li class="text-center">
                                                    <div class="as_progressbar p5"></div>
                                                    <h3>business</h3> 
                                                </li>
                                            </ul>
                                       </div>
                                    ...
                                    <div class="tab-pane fade" id="this-week" role="tabpanel" aria-labelledby="This-Week">
                                        <div class="as_countdown_wrapper">
                                            <ul>
                                                <li class="text-center">
                                                    <span>45%</span>
                                    ...
                                    <div class="tab-pane fade" id="this-month" role="tabpanel" aria-labelledby="This-Month">
                                        <div class="as_countdown_wrapper">
                                            <ul>
                                                <li class="text-center">
                                                    <span>45%</span>
                                    ...
                                    <div class="tab-pane fade" id="this-year" role="tabpanel" aria-labelledby="This-Year">
                                        <div class="as_countdown_wrapper">
                                            <ul>
                                                <li class="text-center">
                                                    <span>45%</span>
        ...
        <section class="as_tarotReading_wrapper as_padderBottom80 as_padderTop80">
            <div class="container">
                <div class="row">
                    <div class="col-lg-12 text-center">
                        <h1 class="as_heading as_heading_center">Your Daily Tarot Reading</h1>
                        <p class="as_padderBottom50">Consectetur adipiscing elit, sed do eiusmod tempor incididuesdeentiut labore <br> etesde dolore magna aliquapspendisse and the gravida.</p>

                        <div class="row as_card_slider">
                            <div class="col-lg-3 col-md-6 col-sm-12">
                                <div class="as_card_box">
                                    <a href="javascript:;"><img src="https://dummyimage.com/270x360" alt=""></a>
                                </div> 
                            </div>
                            <div class="col-lg-3 col-md-6 col-sm-12">
                                <div class="as_card_box">
