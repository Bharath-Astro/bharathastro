<%@ Page Title="" Language="C#" MasterPageFile="~/AstroMaster.master" AutoEventWireup="true" CodeFile="report-ask-principle-astrologer.aspx.cs" Inherits="report_ask_principle_astrologer" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
        ...
        <div class="container">
            <div class="row as_verticle_center">
                <div class="col-lg-7 col-md-7">
                    <h1 class="heading"> Get Your Queries Answered by Our Principal Astrologer - Pt. Rishiraj Tiwari </h1>
                    <div class="img_wrap">
                        <img src="../images/expert2.webp" alt="" class="img-fluid">
                        Pt. Rishiraj Tiwari is a well-known Vedic Astrologer and Vastu Consultant based in Mumbai. A post-graduate in Vedic Astrology from Sampurnanand Sanskrit Vishwavidyalaya, Varanasi, Panditji has been practicing Vedic Astrology for 30 years. He has among his clients many corporate executives, businessmen, politicians, actors from the TV industry and Bollywood celebrities.
                    </div>
                    <div class="rt_inner">
                        <div class="rt_top bg_d_red"> Love </div>
                        <div class="rt_top bg_d_green"> Health </div>
                        <div class="rt_top bg_d_gold"> Career </div>
                        <div class="rt_top bg_d_brown"> Education </div>
                        <div class="rt_top bg_d_violet"> Marriage </div>
                        <div class="rt_top bg_d_orange"> Business </div>
                        <div class="rt_top bg_d_yellow"> Travel </div>
                        <div class="rt_top bg_d_blue"> Muhurt </div>
                        <div class="rt_top bg_d_grey"> Finance </div>
                    </div>
                </div>
                <div class="col-lg-5 col-md-5">
                    <div class="as_service_box">
                        <h3> Ask Your Questions Now </h3>
                        <p> Getting answer to your question by expert astrologer has never been this easy and cost effective. </p>
                        <div class="pt-20"></div>
                        ...
                        <p class="pt-20"><u>Ask one question in ₹599 and two questions in just ₹899.</u></p>
                        <div class="pt-20">
                            <a href="#form" class="as_btn"> Consult Now </a>
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div class="row" id="form">
                <div class="col-lg-8 col-md-8 offset-lg-2 offset-md-2">
                    <div class="as_journal_box_wrapper mt-60">
                        <form>
                            <h1 class="text-center heading"> Get Help for Your Problems from Our Expert Astrologer </h1>
                            <div class="row pt-30">
    ...
    <section class="as_service_wrapper as_padderTop50 as_padderBottom80">
        <div class="container">
            ...
            <div class="row pt-40">
                <div class="col-lg-7">
                    <h1 class="heading pt-40"> Now You Can Consult Our Principal Astrologer Easily </h1>
                    <p class="pt-10"> Ask your questions regarding career, health, marriage, relationships, or any other area of life. And, get answers with a high level of accuracy and effective remedial measures from our Principal Astrologer, Pt. Rishiraj Tiwari.</p>
                    <ul class="as_importance_list">
                        <li> Panditji takes only 10 questions in a day so that he can personally work on each query. You get your answers and remedial measures by an expert! </li>
                        <li> You get effective and easy to follow remedial measures </li>
                        <li> You get the response emailed to the given email id within 48 to 72 hours. </li>
                    </ul>
                </div>
                <div class="col-lg-5">
                    <div class="as_service_box">
    ...
    <section class="as_about_wrapper as_padderTop50 as_padderBottom80">
        <div class="container">
            ...
            <div class="row">
                <div class="col-lg-7">
                    <h1 class="heading pt-40"> How Consult Our Principal Astrologer Works </h1>
                    <p class="pt-20"> It's really easy! Just follow the steps given below and your query will reach our Pt. Rishiraj Tiwari in no time! </p>
                    <div class="rapa_box">
                        <div class="rapab_inner">
                            <div class="ri_n"> 1 </div>
                            <div class="ri_p"> Enter Your Birth Details </div>
                        </div>
                        <div class="rapab_inner">
                            <div class="ri_n"> 2 </div>
                            <div class="ri_p"> Verify and Confirm Your Details </div>
                        </div>
                        <div class="rapab_inner">
                            <div class="ri_n"> 3 </div>
                            <div class="ri_p"> Select Preferred Language of Answer </div>
                        </div>
                        <div class="rapab_inner">
                            <div class="ri_n"> 4 </div>
                            <div class="ri_p"> Ask Your Question - You can either choose from the dropdown list of questions or type your own question. Just remember to type specific questions. You can add additional details if you think it is important information. </div>
                        </div>
                        <div class="rapab_inner">
                            <div class="ri_n"> 5 </div>
                            <div class="ri_p"> Make the Payment to Confirm Your Order </div>
                        </div>
                    </div>
                </div>
                <div class="col-lg-5">
                    <div class="as_service_box bg_primary">
                        <h3> Ask Your Questions Now </h3>
                        <p> Getting answer to your question by expert astrologer has never been this easy and cost effective. </p>
                        <div class="pt-20"></div>
                        <ul class="as_importance_list">
            ...
            <div class="row pt-40">
                <div class="col-lg-10 offset-lg-1">
                    ...
                    <div class="as_service_box r_p">
                        ...
                        <p> "This was my second service purchased from your site. I am satisfied the way you interpret and explain the results in brief. However, I am waiting for the predictions to get true by the passing time. Hope, all whatever have been send in reports are genuine. Also, i would like to share a feedback that you should take less time in delivering your services. Good wishes to your team" <br>
                            <strong> -Devendar Joshi </strong> </p>
                    </div>
                    <div class="as_service_box r_p">
                        <img src="../images/varshUser4.webp" alt="" class="img-fluid">
                        <p> "There was a deep description of the Planetary positions in the birth chart and the perfect explanation for the questions asked and they have given remedies to do for they development of our Future Life." <br> <strong> -Dipti Mehta </strong>
                        </p>
                    </div>
                    <div class="as_service_box r_p">
                        <img src="../images/varshUser5.webp" alt="" class="img-fluid">
                        <p> "Suggestion and remedies given by astrologer are highly satisfactory towards my questions." <br> <strong> -Amar Singh </strong> </p>
                    </div>
